...
const Sections = ({results}) => {
  ...
  return sectionNames.map((section)=> {
    ...
    return (
      <li key={section.toLowerCase()} className='md:flex flex-col gap-2'>
        <h3 className='font-bold text-blue-900 text-xl py-2 text-center bg-blue-50 rounded-md p-2'>{section}</h3>
